...
export function useGetAgentByIdQuery(id: string, options: any) {
 return { data: options.enabled ? { id, avatar: { filepath: id === 'agent_6llV0eMu4fmIaj8f2x1Sb' ? '/agent-agent_6llV0eMu4fmIaj8f2x1Sb-avatar-1788871984269.png' : '/test-portrait.svg' } } : undefined };
}
