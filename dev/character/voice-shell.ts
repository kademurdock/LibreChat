...
export function useGetAgentByIdQuery(id: string, options: any) {
 return { data: options.enabled ? { id, avatar: { filepath: id === 'agent_6llV0eMu4fmIaj8f2x1Sb' ? '/agent-agent_6llV0eMu4fmIaj8f2x1Sb-avatar-1789863013865.png' : id === 'agent_BSOLa3eNEZyjs-7abCjMt' ? '/agent-agent_BSOLa3eNEZyjs-7abCjMt-avatar-1788941611099.png' : '/test-portrait.svg' } } : undefined };
}
