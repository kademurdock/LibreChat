...
<div><button onClick={()=>play('one')}>Play saved voice</button><button onClick={()=>play('two')}>Play another character</button><button onClick={()=>{audio.pause();audio.src='';}}>Interrupt</button></div>
