...
export const kadePhoneCallSchema: ExtendedJsonSchema = {
  ...
  properties: {
    ...
    call_as: {
      type: 'string',
      description:
        "HOST PRIVILEGE — works ONLY when you are Kiana. The NAME of another character who should place this call instead (their own voice and persona), e.g. call_as='Lilly' to have Lilly call Skylee. Any other character given this request must tell the user to ask Kiana — she is the host and the only one who can hand calls to the rest of the cast.",
    },
  },
  required: [],
};
