...
async function seedSounds() {
  ...
  try {
    ...
    const rooms = { alder_trail: 'amb.woods.day', reedbank_creek: 'amb.creek.bank', alder_camp: 'amb.camp.fire', alder_hide: 'amb.woods.day', pats_diner: 'amb.diner.quiet', the_archive: 'amb.archive.quiet' };
