...
const TOPICS = {
  ...
  sound: { title: 'Sound', text: 'Every event has a sound, and the sounds carry the game: your screen reader announces, the earcons play. Toggle sounds and ambience in the bar. Each ward has a sound bed and rooms have their own tone; the freight horn at 11:40 reaches every ward at its own distance. A bite while fishing is a sound, not a line.' },
...
registry.register({
  ...
  async run(ctx) {
    ...
    if (coin < 15) ideas.push('Coin is low. Work a shift — the docks pay, so does Pat’s sink — or fish off Pier Seven and sell the catch.');
