...
const guide=vm.runInNewContext('('+backend.slice(a,b)+')',{SCREENPLAY_HELP:'Actor directions in brackets; spoken text outside brackets.',yueCost:'No reliable per-song cost estimate yet. YuE2 currently does not deduct from your credit balance.'});
const sent=[],errors=[];
