...
const TOOLS = [
  ...
  { id: 'readingroom', href: '/reading-room', title: 'The Reading Room', spoken: 'The Reading Room', icon: '📚',
    hint: 'Books read aloud by a voice you pick, with bookmarks and chapters, plus the family library of donated audiobooks, described movies, cassettes and old radio.' },
