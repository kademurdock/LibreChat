...
router.post('/', requireJwtAuth, async (req, res) => {
  try {
    ...
    const persona = String((req.body && req.body.persona) || '').trim().slice(0, 4000);
...
<form id="builder" hidden>
  ...
  <div class="card">
    ...
    <textarea id="persona" maxlength="4000" aria-label="Your Spotter's personality, in your own words or generated"></textarea>
